<?php
// Include head.php from local conf directory if exists, otherwise from GitHub
if (file_exists('../conf/head.php')) {
...
<?php
// Include foot.php from local conf directory if exists, otherwise from GitHub
if (file_exists('../conf/foot.php')) {
