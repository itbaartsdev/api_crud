...
$(function () {
   ...
   // Language translation disabled for simplified interface
   // Internationalization features removed to prevent 404 errors
   /*
   ...
   i18next.use(window.i18nextXHRBackend).init(
      {
         ...
         fallbackLng: "en",
         backend: {
            loadPath: "azzam/app-assets/data/locales/{{lng}}.json"
         },
         returnObjects: true
      },
      function (err, t) {
